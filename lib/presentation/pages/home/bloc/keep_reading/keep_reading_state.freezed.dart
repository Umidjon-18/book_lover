...
class __$$KeepReadingErrorCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_$KeepReadingError(
      error: freezed == error
          ? _value.error
...
class _$KeepReadingError implements KeepReadingError {
  const _$KeepReadingError({this.error});
  ...
  @override
  String toString() {
    return 'KeepReadingState.error(error: $error)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$KeepReadingErrorCopyWith<_$KeepReadingError> get copyWith =>
      __$$KeepReadingErrorCopyWithImpl<_$KeepReadingError>(this, _$identity);
...
abstract class KeepReadingError implements KeepReadingState {
  const factory KeepReadingError({final String? error}) = _$KeepReadingError;
