...
import 'presentation/pages/collections/bloc/collections_page_cubit.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(create: (context) => TrendingPageCubit()),
        BlocProvider(create: (context) => CollectionsPageCubit()),
      ],
      child: child,
    );
  }
